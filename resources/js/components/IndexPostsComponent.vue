<template>
 <div>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <button :class="{disable: !postsobject.prev_page_url}" @click="go(postsobject.prev_page_url)" class="btn btn-info mx-3">Previous</button> <p class="m-0">{{currentPage}}/{{lastPage}}</p> <button :class="{disable: !postsobject.next_page_url}" @click="go(postsobject.next_page_url)" class="btn btn-info mx-3">Next</button>
    </div>
 </div>
</template>
